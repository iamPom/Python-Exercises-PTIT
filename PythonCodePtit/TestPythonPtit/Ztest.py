...
# Câu 1
dictTinh = {'001': 'Hà Nội', '008': 'Tuyên Quang', '004': 'Cao Bằng', '019': 'Thái Nguyên', '020': 'Lạng Sơn',
            '022': 'Quảng Ninh', '026': 'Vĩnh Phúc', '031': 'Hải Phòng'}
...
for item in list_cd:
    info = item.fullname + '       ' + item.gioitinh + '   ' + str(
        item.tuoi) + '  ' + item.quequan + '    ' + item.email
    print(info)
